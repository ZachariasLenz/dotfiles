...
return require("packer").startup(function(use)
   ...
   -- Adds a reverse-J ('join lines') command.
   use({
   ...
   use({
      ...
      config = function()
         require("zl.plugin.thesaurus_query")
      end,
   })
   ...
   use({
      ...
      cond = function()
         ...
         return not vim.tbl_contains(utils.filetypes.text, vim.bo.filetype)
      end,
   })
   ...
   -- Run tests and view the results directly in Neovim.
   use({
      "rcarriga/vim-ultest",
